 ...
 * @author Jeff Butler
 */
public class AnnotatedUpdateByPrimaryKeyIncludeNullMethodGenerator extends UpdateByPrimaryKeySelectiveMethodGenerator {

    public AnnotatedUpdateByPrimaryKeyIncludeNullMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Method method) {
        ...
        sb.append(introspectedTable.getUpdateByPrimaryKeyIncludeNullStatementId());
        sb.append("\")"); //$NON-NLS-1$
